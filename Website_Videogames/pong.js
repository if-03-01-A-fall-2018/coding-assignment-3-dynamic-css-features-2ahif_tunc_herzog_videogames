...
var Game = {
	...
	update: function () {
		...
		if (this.ball.x <= 0) Pong._resetTurn.call(this, true);
		if (this.ball.x >= this.canvas.width - this.ball.width) Pong._resetTurn.call(this, false);
	...
	_resetTurn: function (paddlePoint) {
		min = 0;
		max = 1;
